							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="form-control" placeholder="蔡新局通信楼" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"  class="form-control" placeholder="1234578" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-3"  class="form-control" placeholder="123456" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<input type="text" id="form-field-5"  class="form-control" placeholder="洞山中路龙泉山庄"/>	
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<input type="text" id="form-field-7"  class="form-control" placeholder="商用" />	
										</div>	
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<input type="text" id="form-field-8"  class="form-control" placeholder="仓库" />	
										</div>	
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<input type="text" id="form-field-9"  class="form-control" placeholder="框架" />	
										</div>	
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<input type="text" id="form-field-10"  class="form-control" placeholder="6" />	
										</div>	
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												<input type="text" id="form-field-11"  class="form-control" placeholder="98.45" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												<input type="text" id="form-field-12"  class="form-control date-picker" data-date-format="dd-mm-yyyy" type="text" name="" placeholder="27-3-2017" />
												<span class="input-group-addon">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<input type="text" id="form-field-13"  class="form-control" placeholder="12345" />	
										</div>	
									</div>
