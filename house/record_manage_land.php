        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $('#records tbody').on( 'click', '.delete', function () {
                 ...
                 function drawlink(){
                    $('#records tbody>tr').find('td:gt(7):not(:last)').html("<a href='upload_s.php'>上传</a>");
                       
                         $('#records tbody>tr').find('td:last').html("<a href='edit_record_land.php'>编辑</a>|<a href='javascript:;' class='delete'>删除</a>"); 
                 }
            })
        </script>
    </body>
