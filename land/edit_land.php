...
?>
					<div id="breadcrumbs" class="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="edit_land.php">修改土地</li>
						</ul>
					</div>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="form-control" placeholder="三等地" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"  class="form-control" placeholder="张三" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-3"  class="form-control" placeholder="淮南" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<input type="text" id="form-field-5"  class="form-control" placeholder="建设学校"/>	
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												<input type="text" id="form-field-11"  class="form-control" placeholder="购买" />
